...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Welcome Dark Hub!<Color=/>"):Display()
    wait(.5)
    ...
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: Darkz<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Dark Hub", HidePremium = false, IntroText = "DarkHub Library", SaveConfig = true, ConfigFolder = "Dark Hub"})
...
W:AddLabel("Script By Darkz")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Welcome to Dark Hub!")
W:AddLabel("[+] Discord: https://discord.gg/QjcuWPdqec")
